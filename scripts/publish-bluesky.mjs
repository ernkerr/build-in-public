...
// Usage:
//   node scripts/publish-bluesky.mjs --file <path> [--image <path>]   (recommended)
//   node scripts/publish-bluesky.mjs "post content" [image-path]      (legacy, unsafe for multi-line)
//
...
if (!content) {
  console.error("Usage: node scripts/publish-bluesky.mjs --file <path> [--image <path>]");
  process.exit(1);
}
