...
Read `data/local/drafts.md` and show all drafts with status `pending`:
...
**Approve**: Change status in `data/local/drafts.md` to `approved`
**Delete**: Remove the row from `data/local/drafts.md`
